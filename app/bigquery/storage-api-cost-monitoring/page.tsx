        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent className="text-2xl font-bold">{data?.summary.totalApiCost}</CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-2"><CardTitle>Top Dataset/Table</CardTitle></CardHeader>
              <CardContent className="text-2xl font-bold">{data?.summary.topTable}</CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-2"><CardTitle>Potential Savings</CardTitle></CardHeader>
              <CardContent className="text-2xl font-bold">{data?.summary.potentialSavings}</CardContent>
            </Card>
          </div>
          {/* Charts */}
